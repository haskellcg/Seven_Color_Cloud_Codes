...
public partial class MemberMana_MemberListMana : MerchantManaBase
{
    ...
    {
        Response.Redirect("SearchMemberMana.aspx");
    }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditMember")
        {
            ...
            Response.Redirect("EditMemberMana.aspx?id=" + strmemid);
        }
    }
}
